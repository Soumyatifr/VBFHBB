...
"/store/data/Run2022C/JetMET/MINIAOD/19Dec2023-v1/2540000/0081d8e6-9fbd-4bf7-8c6d-0e7e4f4b7105.root"
...
process.mytuple = cms.EDAnalyzer(
    ...
    jec_corr_l1_tag   = cms.string("Summer22_22Sep2023_RunCD_V2_DATA_L1FastJet_AK4PFPuppi"),
    jec_corr_l2_tag   = cms.string("Summer22_22Sep2023_RunCD_V2_DATA_L2Relative_AK4PFPuppi"),
    jec_corr_l3_tag   = cms.string("Summer22_22Sep2023_RunCD_V2_DATA_L3Absolute_AK4PFPuppi"),
    jec_corr_l2l3res_tag = cms.string("Summer22_22Sep2023_RunCD_V2_DATA_L2L3Residual_AK4PFPuppi"),
    jec_corr_pnet_l2_tag   = cms.string("Summer22_22Sep2023_RunCD_V2_DATA_L2Relative_AK4PFPuppiPNetRegressionPlusNeutrino"),
    jec_corr_pnet_l2l3res_tag = cms.string("Summer22_22Sep2023_RunCD_V2_DATA_L2L3Residual_AK4PFPuppiPNetRegressionPlusNeutrino"),
