...
config.General.requestName = 'crab_JetMET_Run2022F'
...
config.JobType.psetName = 'run_modules_2022F_final.py'
...
config.Data.inputDataset = '/JetMET/Run2022F-19Dec2023-v2/MINIAOD'
