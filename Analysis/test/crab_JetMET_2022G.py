...
config.General.requestName = 'crab_JetMET_Run2022G'
...
config.JobType.psetName = 'run_modules_2022G_final.py'
...
config.Data.inputDataset = '/JetMET/Run2022G-19Dec2023-v1/MINIAOD'
